...
def joinFactors(factors: List[Factor]):
    ...
    for assignment in new_factor.getAllPossibleAssignmentDicts():
        ...
        for factor in factors_list:
            new_factor.setProbability(assignment, new_factor.getProbability(assignment) * factor.getProbability(assignment))
    return new_factor
    "*** END YOUR CODE HERE ***"
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        "*** YOUR CODE HERE ***"
        new_factor = Factor(factor.unconditionedVariables() - {eliminationVariable}, factor.conditionedVariables(), factor.variableDomainsDict())
