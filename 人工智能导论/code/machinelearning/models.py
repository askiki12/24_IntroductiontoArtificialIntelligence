...
class RegressionModel(object):
    ...
    def run(self, x):
        ...
        r = nn.ReLU(nn.AddBias(x_w0, self.b0))
        x_w1 = nn.Linear(r, self.w1)
        return nn.AddBias(x_w1, self.b1)
...
class DigitClassificationModel(object):
    ...
    def run(self, x):
        ...
        """
        "*** YOUR CODE HERE ***"
        w0_x = nn.Linear(x, self.w0)
        r1 = nn.ReLU(nn.AddBias(w0_x, self.b0))
        w1_x = nn.Linear(r1, self.w1)
        return nn.AddBias(w1_x, self.b1)
